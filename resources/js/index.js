...
let inputName = document.querySelector('#kupac')
inputName.textContent = ''

const mainLabel = document.querySelector('#select-dino')
...
dinos.forEach(el=> {
    ...
    mainLabel.appendChild(option)
})

const inputCont = document.querySelector('#item-container')
...
form.addEventListener('submit', (e) => {
    if(!validForm()){
        ...
        greska.innerText = 'Polja ne smeju biti prazna i duzina karaktera mora biti 4'
  ...
  return }
    ...
    item.textContent = inputName.value + option.value + option.price + d
    let d = new Date()
